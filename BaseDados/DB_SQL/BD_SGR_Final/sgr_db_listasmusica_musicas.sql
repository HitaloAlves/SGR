...
CREATE TABLE `listasmusica_musicas` (
  ...
  KEY `Musicas_id` (`Musicas_id`),
  CONSTRAINT `listasmusica_musicas_ibfk_1` FOREIGN KEY (`ListasMusica_id`) REFERENCES `listasmusica` (`id`),
  CONSTRAINT `listasmusica_musicas_ibfk_2` FOREIGN KEY (`Musicas_id`) REFERENCES `musicas` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `listasmusica_musicas` VALUES (1,1),(2,2),(3,3);
...
-- Dump completed on 2017-11-20  0:38:27
