...
public class AcessoController extends Controller {
    ...
    public void fazerLoginLocutor() {

        Acesso loginL = new Acesso(this.email, this.senha, 2);
        
        if (loginL.getAcesso()) {
            this.valid = true;
        } else {
            this.valid = false;
            this.retornoMsg = loginL.getMessage();
        }

    }
    
    public void fazerLoginRadio() {

        Acesso loginL = new Acesso(this.email, this.senha, 1);
