...
CREATE TABLE `programasradio` (
  `idProgramasRadio` int(11) NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `programasradio_ibfk_1` FOREIGN KEY (`Radios_idRadios`) REFERENCES `radios` (`idRadios`)
...
-- Dump completed on 2017-09-23 17:39:14
