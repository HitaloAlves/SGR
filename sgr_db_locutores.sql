...
CREATE TABLE `locutores` (
  ...
  KEY `fk_Locutores_Radios1_idx` (`Radios_idRadios`),
  CONSTRAINT `fk_Locutores_Radios1` FOREIGN KEY (`Radios_idRadios`) REFERENCES `radios` (`idRadios`)
...
-- Dump completed on 2017-09-21 18:03:58
