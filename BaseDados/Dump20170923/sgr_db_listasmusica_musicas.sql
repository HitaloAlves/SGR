...
CREATE TABLE `listasmusica_musicas` (
  ...
  KEY `fk_ListasMusica_Musicas_Musicas1` (`Musicas_idMusicas`),
  CONSTRAINT `fk_ListasMusica_Musicas_Musicas1` FOREIGN KEY (`Musicas_idMusicas`) REFERENCES `musicas` (`idMusicas`),
  CONSTRAINT `listasmusica_musicas_ibfk_1` FOREIGN KEY (`ListasMusica_idListasMusica`) REFERENCES `listasmusica` (`idListasMusica`)
...
-- Dump completed on 2017-09-23 17:39:58
