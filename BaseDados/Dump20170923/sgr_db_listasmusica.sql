...
CREATE TABLE `listasmusica` (
  `idListasMusica` int(11) NOT NULL AUTO_INCREMENT,
  ...
  KEY `fk_ListasMusica_Radios1` (`Radios_idRadios`),
  CONSTRAINT `fk_ListasMusica_Radios1` FOREIGN KEY (`Radios_idRadios`) REFERENCES `radios` (`idRadios`),
  CONSTRAINT `listasmusica_ibfk_1` FOREIGN KEY (`Locutores_idLocutores`) REFERENCES `locutores` (`idLocutores`)
...
-- Dump completed on 2017-09-23 17:39:19
