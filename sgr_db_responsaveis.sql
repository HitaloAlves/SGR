...
CREATE TABLE `responsaveis` (
  ...
  KEY `fk_Responsaveis_Radios1_idx` (`Radios_idRadios`),
  CONSTRAINT `fk_Responsaveis_Radios1` FOREIGN KEY (`Radios_idRadios`) REFERENCES `radios` (`idRadios`)
...
-- Dump completed on 2017-09-21 18:04:09
