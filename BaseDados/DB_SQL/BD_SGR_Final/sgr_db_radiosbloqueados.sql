...
CREATE TABLE `radiosbloqueados` (
  ...
  CONSTRAINT `radiosbloqueados_ibfk_1` FOREIGN KEY (`Radio_id`) REFERENCES `radios` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `radiosbloqueados` VALUES (1),(2),(3);
...
-- Dump completed on 2017-11-20  0:38:42
