...
CREATE TABLE `programasradio_convidados` (
  ...
  KEY `fk_ProgramasRadio_Convidados_Convidados1_idx` (`Convidados_idConvidados`),
  KEY `fk_ProgramasRadio_Convidados_ProgramasRadio1_idx` (`ProgramasRadio_idProgramasRadio`,`ProgramasRadio_Radios_idRadios`),
  CONSTRAINT `fk_ProgramasRadio_Convidados_Convidados1` FOREIGN KEY (`Convidados_idConvidados`) REFERENCES `convidados` (`idConvidados`),
  CONSTRAINT `fk_ProgramasRadio_Convidados_ProgramasRadio1` FOREIGN KEY (`ProgramasRadio_idProgramasRadio`, `ProgramasRadio_Radios_idRadios`) REFERENCES `programasradio` (`idProgramasRadio`, `Radios_idRadios`)
...
-- Dump completed on 2017-09-21 18:03:24
