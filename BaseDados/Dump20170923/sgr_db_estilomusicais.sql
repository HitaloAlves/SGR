...
CREATE TABLE `estilomusicais` (
  `idEstiloMusicais` int(11) NOT NULL AUTO_INCREMENT,
  `nomeEstiloMusicais` varchar(20) DEFAULT NULL,
  `Musicas_idMusicas` int(11) NOT NULL,
  PRIMARY KEY (`idEstiloMusicais`,`Musicas_idMusicas`),
  KEY `Musicas_idMusicas` (`Musicas_idMusicas`),
  CONSTRAINT `estilomusicais_ibfk_1` FOREIGN KEY (`Musicas_idMusicas`) REFERENCES `musicas` (`idMusicas`)
...
-- Dump completed on 2017-09-23 17:39:08
